...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___project_link'
  | 'childMarkdownRemark___frontmatter___objectPosition'
...
export type MarkdownRemarkFieldsEnum = 
  ...
  | 'frontmatter___project_link'
  | 'frontmatter___objectPosition'
  | 'excerpt'
  | 'rawMarkdownBody'
  | 'fileAbsolutePath'
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  project_link?: Maybe<StringQueryOperatorInput>;
...
export type BlogPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, blogPosts: { edges: Array<{ node: (
...
export type HomePageQuery = { hero?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, projects: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'category'>
          & { thumbnail?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
        )> }
      ) }> }, blogPosts: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'description'>> }
      ) }> } };
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'siteUrl' | 'author'>> }>, avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }>, markdownRemark?: Maybe<(
...
export type ProjectBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'>
    & { frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'project_link' | 'objectPosition'>
      & { thumbnail?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
    )> }
  )> };
